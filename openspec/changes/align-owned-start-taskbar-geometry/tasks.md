...
- [ ] 1.1.1 Add shell and row inputs to Start geometry/options.
- [ ] 1.1.2 Compute matching preview/shell taskbar top and bounded Start size.
- [ ] 1.1.3 Pass runtime mode and settings rows through Start composition.
...
- [ ] 1.2.1 Test preview and shell anchors with stale work-area reservation.
- [ ] 1.2.2 Test 640×720 preference across DPI and 1–3 rows.
- [ ] 1.2.3 Test negative origins, small monitors, centering and non-overlap.
...
- [ ] 2.1.1 Add Explorer suppression, watchdog, shell launch and recovery fields.
- [ ] 2.1.2 Record Start/taskbar/monitor geometry and derived DIP values.
- [ ] 2.1.3 Preserve UIA sections/actions, screenshots, locale and binary hashes.
...
- [ ] 2.2.1 Enforce width, gap, containment and non-overlap thresholds.
- [ ] 2.2.2 Mark `gui-start` Explorer-free and reject new system Start/Search/Shell PIDs.
- [ ] 2.2.3 Run focused and full shell-parity UTIT and validate report hashes.
...
- [ ] 3.1.1 Run format and focused/workspace locked offline tests.
- [ ] 3.1.2 Run Clippy, architecture/source audits and release build.
- [ ] 3.1.3 Inspect screenshots and pass strict/detailed validation.
