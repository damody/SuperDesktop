...
系統 SHALL 記錄 OS build 26200.9168、ExplorerPatcher 26100.8457.70.3、設定摘要、reference image SHA-256、GPUI source revision 與 1.1 read-only profile/admission probe binary hash。該 binary MUST NOT 建立 HWND、AppBar、Shell Hook或修改 Explorer；native-window spike binary 屬後續 1.2。
