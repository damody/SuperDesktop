...
The Start UTIT home contract will require Pinned, Recommended, and Power, require the Settings footer control to be absent, count exactly one footer action, measure the Power hit target at 38-42 DIP, and prove it is right-aligned within the footer. Power expansion, three owned actions, dismissal, Explorer absence, and recovery remain mandatory.
