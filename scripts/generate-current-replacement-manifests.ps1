...
'dependency-current-inputs.sha256'=@('Cargo.toml','Cargo.lock','.cargo/config.toml','rust-toolchain.toml','openspec/changes/bootstrap-superdesktop-workspace/evidence/artifacts/1.2/dependency-provenance.json')+(LegacyPaths '1.2/dependency-inputs.sha256')
